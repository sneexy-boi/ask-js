...
export class Migration1740343719757 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "invite" ("id" character varying NOT NULL, "used" boolean NOT NULL DEFAULT false, "code" character varying NOT NULL, "creator" character varying NOT NULL, "createdAt" character varying NOT NULL, CONSTRAINT "PK_fc9fa190e5a3c5d80604a4f63e1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_private" ("id" character varying NOT NULL, "password" character varying NOT NULL, CONSTRAINT "PK_e6bf0ac016c44867edaaeeccec3" PRIMARY KEY ("id"))`);
